            ...
            <div className='wrapper flex lg:flex-row flex-col-reverse gap-8 pt-5 pb-16'>
                <div className='w-full px-3 lg:px-0 lg:w-1/2'>
                    ...
                    <div className='flex flex-col gap-5 mt-3'>
                        <div className='flex'>
                            <img src={missionImg} alt="mission image" className='object-fit w-1/2 md:w-[45%] lg:w-[40%]' />
                            <div>
                        ...
                        <div className='flex'>
                            <img src={visionImg} alt="vision image" className='object-fit w-1/2 md:w-[45%] lg:w-[40%]' />
                            <div>
